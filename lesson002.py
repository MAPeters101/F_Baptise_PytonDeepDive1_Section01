...
Any short introductory Python course will do, and I will recap some of the
basics in Section 2 of this course.

You should also be familiar, though not necessarily in Python, with general
...
or Jupyter notebooks (which I use throughout this course so as to provide you
fully annotated Python code samples).
"""